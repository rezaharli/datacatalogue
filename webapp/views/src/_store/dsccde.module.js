...
const state = {
    all: {
        ...
        leftHeaders: [
            ...
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: false, text: 'CDE', value: 'CDE' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: false, text: 'Description', value: 'DESCRIPTION' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: false, text: 'Table Name', value: 'TABLE_NAME' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: false, text: 'Column Name', value: 'ColumnsVal.COLUMN_NAME' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: false, text: 'Downstream Process', value: 'ColumnsVal.DSP_NAME' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: false, text: 'Downstream Process Owner', value: 'ColumnsVal.PROCESS_OWNER' },
        ],
        isRightTable: false,
        DDSource: [],
        detailsLoading: true,
