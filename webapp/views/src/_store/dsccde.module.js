...
const state = {
    all: {
        ...
        leftHeaders: [
            ...
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: true, text: 'Downstream Process', value: 'DSP_NAME' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: true, text: 'Downstream Process Owner', value: 'PROCESS_OWNER' },
        ],
        isRightTable: false,
        DDSource: [],
        detailsLoading: true,
