...
const state = {
    all: {
        ...
        leftHeaders: [
            ...
            { align: 'left', display: true, exportable: true, displayCount: false, sortable: true, filterable: true, text: 'In Hadoop (Y/N)', value: 'TABLE_NAME' },
            { align: 'left', display: true, exportable: true, displayCount: false, sortable: true, filterable: true, text: 'In Teradata Tier 1 (Y/N)', value: 'COLUMN_NAME' },
            { align: 'left', display: true, exportable: true, displayCount: false, sortable: true, filterable: true, text: 'In Tier 2 FSDM (Y/N)', value: 'BUSINESS_ALIAS_NAME' },
            { align: 'left', display: true, exportable: true, displayCount: false, sortable: true, filterable: true, text: 'In Tier 2 AES (Y/N)', value: 'BUSINESS_ALIAS_DESCRIPTION' },
        ],
        isRightTable: false,
        DDSource: [],
        detailsLoading: true,
