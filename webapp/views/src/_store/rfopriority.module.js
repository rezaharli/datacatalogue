...
const state = {
    all: {
        ...
        exportDatas: [],
        leftHeaders: [
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: true, text: 'Priority Report', value: 'PRIORITY_REPORT' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: true, text: 'Priority Report Rationale', value: 'PRIORITY_REPORT_RATIONALE' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: true, text: 'CRM Name', value: 'CRM_NAME' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: true, text: 'CRM Rationale', value: 'CRM_RATIONALE' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: true, text: 'CDE Name', value: 'CDE_NAME' },
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: true, text: 'CDE Rationale', value: 'CDE_RATIONALE' },
        ],
        isRightTable: false,
        DDSource: [],
        detailsLoading: true,
