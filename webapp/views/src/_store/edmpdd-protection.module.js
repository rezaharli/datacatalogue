...
const state = {
    all: {
        ...
        leftHeaders: [
            ...
            { align: 'left', display: true, exportable: true, displayCount: false, sortable: true, filterable: true, text: 'Mask Data During Testing (Y/N)', value: 'TABLE_NAME' },
            { align: 'left', display: true, exportable: true, displayCount: false, sortable: true, filterable: true, text: 'PII (Y/N)', value: 'COLUMN_NAME' },
            { align: 'left', display: true, exportable: true, displayCount: false, sortable: true, filterable: true, text: 'Determines Client Location (Y/N)', value: 'BUSINESS_ALIAS_NAME' },
            { align: 'left', display: true, exportable: true, displayCount: false, sortable: true, filterable: true, text: 'Determines Account/ Deal Location (Y/N)', value: 'BUSINESS_ALIAS_DESCRIPTION' },
        ],
        isRightTable: false,
        DDSource: [],
        detailsLoading: true,
