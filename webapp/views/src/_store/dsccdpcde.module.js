...
const state = {
    all: {
        ...
        leftHeaders: [
            ...
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: false, text: 'CDE Name', value: 'CDE' },
            ...
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: true, sortable: false, text: 'Column Name', value: 'COLUMN_NAME' },
        ],
        isRightTable: false,
        DDSource: [],
        detailsLoading: true,
...
const actions = {
    exportData({ commit }) {
        ...
        return dscMyService.getCdpCdeTable(param)
            .then(
