...
const state = {
    all: {
        ...
        exportDatas: [],
        leftHeaders: [
            { align: 'left', display: true, filterable: true, exportable: true, displayCount: false, sortable: true, text: 'Downstream Process Name', value: 'DP_NAME' },
...
const actions = {
    exportData({ commit }) {
        ...
        return ddoMyService.getDownstreamTable(state.all.param)
            .then(
