<style>
/* #table-edmp-dd-attribute table.v-table tbody tr {display: block;} */
/* #table-edmp-dd-attribute table.v-table.v-datatable thead{
    width: unset;
    display: table-header-group;
    padding-right: unset;
}
#table-edmp-dd-attribute table.v-table.v-datatable tbody{
...
#table-edmp-dd-attribute table.v-table tr th:nth-of-type(1){width: calc(100%/20) !important; display: table-cell;}
#table-edmp-dd-attribute table.v-table tr th:nth-of-type(2){width: calc(100%/20) !important; display: table-cell;}
#table-edmp-dd-attribute table.v-table tr th:nth-of-type(3){width: calc(100%/20) !important; display: table-cell;}
#table-edmp-dd-attribute table.v-table tr th:nth-of-type(4){width: calc(100%/20) !important; display: table-cell;}
#table-edmp-dd-attribute table.v-table tr th:nth-of-type(5){width: calc(100%/20) !important; display: table-cell;}
#table-edmp-dd-attribute table.v-table tr th:nth-of-type(6){width: calc(100%/20) !important; display: table-cell;}
#table-edmp-dd-attribute table.v-table tr th:nth-of-type(7){width: calc(100%/20) !important; display: table-cell;}
</style>
...
<template>
    <b-row style="margin-top: 10px;margin-bottom: 10px;">
      <b-col>
        <!-- Main content -->
        <div class="table-v2-title">Attribute Metadata</div>
        <v-data-table
...
export default {
  ...
  mounted() {
    ...
    setTimeout(() => {
      this.setTableColumnsWidth($('#table-edmp-dd-attribute'));
    }, 300);

    $("#page-tab #tab-attribute").on('click', function(){
      setTimeout(() => {
        self.setTableColumnsWidth($('#table-edmp-dd-attribute'));
      }, 1);
    });
  },
  updated() {
