          ...
          <b-row>
            <b-col>
              <v-data-table
                ...
                <template slot="items" slot-scope="props">
                    <td><b-link :to="{ path:'/dpo/interfaces/' + props.item.ID }">{{ props.item.System_Name }}</b-link></td>
            ...
            <b-col class="scrollableasdf">
              <v-data-table
                ...
                <template slot="items" slot-scope="props">
                  <td><b-link :to="{ path:'/dpo/interfaces/' + $route.params.system + '/' + props.item.ID }" href="#foo" v-b-modal.modallg>{{ props.item.Name }}</b-link></td>
                  <!-- <td><b-link :to="{ path:'/dpo/interfaces/' + route.params.system + "/details" }" v-b-modal.modallg>{{ props.item.name }}</b-link></td> -->
