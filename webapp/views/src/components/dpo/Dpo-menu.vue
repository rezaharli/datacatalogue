            ...
            <div class="">
                ...
                <b-row>
                    ...
                    <b-col sm=12 md=5 lg=5 class="my-3">
                        <div class="card card-v3 transition link" @click="goToDpoMenuContent('dataelements')">
                            <b-row>
                            ...
                            <h4 class="title-2">{{ store.counts ? store.counts.DATA_ELEMENTS : 0 }}</h4>
                        ...
                        <div class="card card-v3 transition link" @click="goToDpoMenuContent('upstream')">
                            <b-row>
                                ...
                                <b-col cols=8 class="">
                                    <div class="card-content">
                                        <div class="text">
                                            <h6 class="title-1">Upstream Data Providers / Data Lineage</h6>
                                        </div>
                                    </div>
                                </b-col>
                            </b-row>

                            <h4 class="title-2">{{ store.counts ? store.counts.UPSTREAM_DATA : 0 }}</h4>
                            <div class="card-circle-left transition"></div>
                        </div>
                    </b-col>
                    <b-col sm=12 md=1 lg=1 />
...
export default {
    ...
    computed: {
        ...
        store () {
            return this.$store.state.dpo.all
        },
    },
    mounted () {
