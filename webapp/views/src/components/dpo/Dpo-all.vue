            ...
            <b-col>
              <v-data-table
                ...
                <template slot="items" slot-scope="props">
                    <td><b-link :to="{ path:'/dpo/all/' + props.item.ID }">{{ props.item.System_Name }}</b-link></td>
              ...
              <v-data-table
                ...
                <template slot="items" slot-scope="props">
                  <tr @click="props.expanded = !props.expanded">
                    <td><b-link :to="{ path:'/dpo/all/' + $route.params.system + '/' + props.item.ID }" href="#foo" v-b-modal.modallg>{{ props.item.Name }}</b-link></td>
