...
#table-dpo-all table.v-table tr th:nth-of-type(1){width: 55% !important;}
#table-dpo-all table.v-table tr th:nth-of-type(2){width: 45% !important;}
</style>
        ...
        <b-col>
          ...
          <div class="card card-v1 transition">
            <div class="title-wrapper transition">
              ...
              <h2 class="transition title-1">All Processes</h2>
            </div>
    ...
    methods: {
      getLeftTable () {
        ...
        getLeftTableVal.then(res => {
          ...
          this.removeHypenOnEmptyTables($("#table-dpo-all"));
          this.setTableColumnsWidth($('#table-dpo-all'));
        });
      },
      doGetLeftTable () {
