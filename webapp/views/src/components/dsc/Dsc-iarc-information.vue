<style>
/* #table-dsc-dd-information table.v-table tr {display: block;} */
/* #table-dsc-dd-information table.v-table.v-datatable thead{
    width: unset;
    display: table-header-group;
    padding-right: unset;
}
#table-dsc-dd-information table.v-table.v-datatable tbody{
    display:table-row-group;
    overflow:auto;
    max-height:unset;
    width:unset;
}
#table-dsc-dd-information table.v-table.v-datatable tbody tr {display: table-row;} */
#table-dsc-dd-information table.v-table tr th:nth-of-type(1){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(2){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(3){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(4){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(5){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(6){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(7){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(8){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(9){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(10){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(11){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(12){width: calc(100%/20) !important; display: table-cell;}
#table-dsc-dd-information table.v-table tr th:nth-of-type(13){width: calc(100%/20) !important; display: table-cell;}
</style>
...
export default {
  ...
  updated() {
    this.setTableColumnsWidth($('#table-dsc-dd-information'));
  },
  methods: {
    getLeftTable() {
      this.store.system = this.$route.params.system;
