...
#table-ddo-all table.v-table tr th:nth-of-type(1){width: 40% !important;}
#table-ddo-all table.v-table tr th:nth-of-type(2){width: 40% !important;}
#table-ddo-all table.v-table tr th:nth-of-type(3){width: 10% !important;}
#table-ddo-all table.v-table tr th:nth-of-type(1),
#table-ddo-all table.v-table tr td:nth-of-type(1) {padding: 0 15px;}
#table-ddo-all table.v-table tr th:nth-of-type(2),
#table-ddo-all table.v-table tr td:nth-of-type(2) {padding: 0 15px;}
#table-ddo-all table.v-table tr th:nth-of-type(3),
#table-ddo-all table.v-table tr td:nth-of-type(3) {padding: 0 5px 0 15px;}
</style>
    ...
    methods: {
      getLeftTable () {
        ...
        getLeftTableVal.then(res => {
          this.removeHypenOnEmptyTables($("#table-ddo-all"));
          this.setTableColumnsWidth($('#table-ddo-all'));
        });
      },
      doGetLeftTable () {
