            ...
            <div class="">
                ...
                <b-row>
                    ...
                    <b-col sm=12 md=5 lg=5 class="my-3">
                        <div class="card card-v3 transition link" @click="goToDdoMenuContent('businessterm')">
                            <b-row>
                                ...
                                <b-col cols=8 class="">
                                    <div class="card-content">
                                        <div class="text">
                                            <h6 class="title-1">Business Term</h6>
                                        </div>
                                    </div>
                                </b-col>
                            </b-row>
                    ...
                    <b-col sm=12 md=5 lg=5 class="my-3">
                        <div class="card card-v3 transition link" @click="goToDdoMenuContent('systems')">
                            <b-row>
                                <b-col cols=4 class="transition">
                                ...
                                <b-col cols=8 class="">
                                    <div class="card-content">
                                        <div class="text">
                                            <h6 class="title-1">Systems Mapped to Business Terms‌</h6>
                                        </div>
                                    </div>
                                </b-col>
                            </b-row>
                    ...
                    <b-col sm=12 md=1 lg=1 />
                    <b-col sm=12 md=5 lg=5 class="my-3">
                        <div class="card card-v3 transition link" @click="goToDdoMenuContent('downstream')">
                            <b-row>
                                <b-col cols=4 class="transition">
                                ...
                                <b-col cols=8 class="">
                                    <div class="card-content">
                                        <div class="text">
                                            <h6 class="title-1">Downstream Usage</h6>
                                        </div>
                                    </div>
                                </b-col>
                            </b-row>
...
export default {
    ...
    computed: {
        ...
        store () {
            return this.$store.state.ddo.all
        },
    },
    mounted () {
