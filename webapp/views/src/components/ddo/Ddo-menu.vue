            ...
            <div class="">
                ...
                <b-row>
                    ...
                    <b-col sm=12 md=5 lg=5 class="my-3">
                        <div class="card card-v3 transition link" @click="goToDdoMenuContent('cde')">
                            <b-row>
                    ...
                    <b-col sm=12 md=5 lg=5 class="my-3">
                        <div class="card card-v3 transition link" @click="goToDdoMenuContent('cdp')">
                            <b-row>
                                <b-col cols=4 class="transition">
                    ...
                    <b-col sm=12 md=1 lg=1 />
                    <b-col sm=12 md=5 lg=5 class="my-3">
                        <div class="card card-v3 transition link" @click="goToDdoMenuContent('interfaces')">
                            <b-row>
                                <b-col cols=4 class="transition">
