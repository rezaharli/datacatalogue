...
SELECT DISTINCT
  ...
  CASE WHEN TMCD.THRESHOLD = '0' THEN 'NA' ELSE upper(TMCD.THRESHOLD) END AS DPO_THRESHOLD,
  CASE WHEN TBT.THRESHOLD = '0' THEN 'NA' ELSE upper(TBT.THRESHOLD) END AS THRESHOLD_BT_LEVEL
