...
func (s *DSCService) GetDDTable(system string, colFilter interface{}, pagination toolkit.M) ([]toolkit.M, int, error) {
	...
	gridArgs.Colnames = append(gridArgs.Colnames,
		...
		"TABLE_NAME", "COLUMN_NAME", "BUSINESS_ALIAS_NAME", "BUSINESS_ALIAS_DESCRIPTION", "CDE_YES_NO", "DATA_TYPE", "DATA_LENGTH", "EXAMPLE", "DERIVED_YES_NO", "DERIVATION_LOGIC", "SOURCED_FROM_UPSTREAM_YES_NO", "SYSTEM_CHECKS",
