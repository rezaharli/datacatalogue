...
func (s *DSCService) GetEdmpDDTechnicalTable(system string, colFilter interface{}, pagination toolkit.M) (res []toolkit.M, total int, err error) {
	...
	///////// --------------------------------------------------COLUMN FILTER
	gridArgs.Colnames = append(gridArgs.Colnames,
		"COUNTRY", "BUSINESS_SEGMENT", "SOURCE_SYSTEM", "CLUSTER_NAME", "TIER", "ITAM",
		"EDM_SOURCE_SYSTEM_NAME", "DATABASE_NAME", "TABLE_NAME", "COLUMN_NAME",
		"DATA_TYPE", "COLUMN_LENGTH", "NULLABLE", "PRIMARY_KEY", "CERTIFIED", "PROFILE_RESULTS", "DATA_LINEAGE", "BUSINESS_ALIAS_NAME",
